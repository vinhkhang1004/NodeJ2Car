                                ...
                                <tr key={cat._id} className="hover:bg-slate-800/30 transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            {cat.imageUrl ? (
                                                <img src={cat.imageUrl?.startsWith('/') ? `http://localhost:5000${cat.imageUrl}` : cat.imageUrl} alt={cat.name} className="w-8 h-8 rounded object-cover border border-slate-700" />
                                            ) : (
